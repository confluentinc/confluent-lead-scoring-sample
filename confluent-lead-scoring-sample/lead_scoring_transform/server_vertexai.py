...
class LeadScoringTransformerServer(Model):
    ...
    def predict(self, df: pd.DataFrame) -> Union[Dict, ModelInferResponse]:
        # TODO: Select the final set of features here
        final_features = []
        ...
        for row in final_df.itertuples(index=False, name=None):
            ...
            # TODO: Load your model. In this project our team trained our model offline and upload it as a pickle load_pickle_file.
            ...
            for item in row_dict:
                # TODO: After you've got the prediction results, you can do all sorts of things here, including sending them to a kafka topic
